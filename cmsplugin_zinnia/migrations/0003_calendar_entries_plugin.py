...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarEntriesPlugin'
        db.create_table('cmsplugin_calendarentriesplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('cmsplugin_zinnia', ['CalendarEntriesPlugin'])

    def backwards(self, orm):
        # Deleting model 'CalendarEntriesPlugin'
        db.delete_table('cmsplugin_calendarentriesplugin')
    ...
    models = {
        ...
        'cmsplugin_zinnia.queryentriesplugin': {
            'Meta': {'object_name': 'QueryEntriesPlugin', 'db_table': "'cmsplugin_queryentriesplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'number_of_entries': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
